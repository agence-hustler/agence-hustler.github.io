...
// Conversion de toutes les erreurs classiques de PHP en exceptions (comme ça elles seront aussi capturées par notre try catch général)
...
// Fonction qui instancie une connexion à la DB et la retourne (nécessaire pour les classes Manager DAO)
function connectDB()
{
...
// Fonction qui renvoi true si l' utilisateur est connecté, sinon false
